...
let assets = userLogin === adminLogin && userPassword === adminPassword ?
    `You have entered to personal account successfully.` :
    userLogin === adminLogin || userPassword === adminPassword ? `Unfortunately, you entered the wrong login or password.` :
...
if (howMoney < priceWatermelon && whatBuy === watermelon) {
    console.log(`You do not have enough money to buy at least 1(one) ${watermelon}.`);
} else if (howMoney < priceCarrot && whatBuy === carrot) {
    console.log(`You do not have enough money to buy at least 1(one) ${carrot}.`);
} else if (howMoney < pricePotato && whatBuy === potato) {
    console.log(`You do not have enough money to buy at least 1(one) ${potato}.`);
} else if (howMoney < priceApple && whatBuy === apple) {
    console.log(`You do not have enough money to buy at least 1(one) ${apple}.`)
}else if (whatBuy === watermelon) {
    console.log(`You can buy ${Math.floor(howMoney / priceWatermelon)} ${watermelon}(-s) for ${howMoney} UAH and you'll have a change ${howMoney % priceWatermelon} UAH.`);
} else if (whatBuy === carrot) {
  console.log(`You can buy ${Math.floor(howMoney/priceCarrot)} ${carrot}(-s) for ${howMoney} UAH and you'll have a change ${howMoney%priceCarrot} UAH.`);
...
let check = oneSide + twoSide > threeSide && twoSide + threeSide > oneSide && threeSide + oneSide > twoSide ? `This triangle is exist.` :
